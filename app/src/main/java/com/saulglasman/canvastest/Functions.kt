...
fun ViewManager.colorSelectButton(color: Int, isCurrentColor: Boolean, init: ColorSelectButton.() -> Unit = {}) = ankoView({ ColorSelectButton(it, color, isCurrentColor) }, 0, init)